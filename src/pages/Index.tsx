          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">Seamless management and payment for subscriptions services. All-in-one payment services with Pingpay, curated for your use case.</p>
              </div>
